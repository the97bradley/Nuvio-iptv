...
import com.nuvio.app.features.iptv.LiveTvScreen
...
private fun MainAppContent(
    ...
    onSwitchProfile: () -> Unit = {},
        ...
        val liveScrollToTopRequests = remember { MutableSharedFlow<Unit>(extraBufferCapacity = 1) }
    ...
    fun handleRootTabClick(tab: AppScreenTab) {
        ...
        when (tab) {
            ...
            AppScreenTab.Live -> liveScrollToTopRequests.tryEmit(Unit)
                                ...
                                if (!isTabletLayout && !useNativeBottomTabs && navBarStyleSetting == NavBarStyle.CLASSIC) {
                                    NuvioClassicNavigationBar {
                                        ...
                                        NavItem(
                                            ...
                                            onClick = { handleRootTabClick(AppScreenTab.Live) },
                            ...
                            Box(modifier = Modifier.fillMaxSize()) {
                                CompositionLocalProvider(
                                    ...
                                    AppTabHost(
                                        ...
                                        liveScrollToTopRequests = liveScrollToTopRequests,
...
private fun AppTabHost(
    ...
    liveScrollToTopRequests: Flow<Unit>,
    ...
    onPlayIptvChannel: ((com.nuvio.app.features.iptv.IptvChannel) -> Unit)? = null,
        ...
        tabStateHolder.SaveableStateProvider(selectedTab.name) {
            when (selectedTab) {
                ...
                AppScreenTab.Live -> {
                    LiveTvScreen(
                        modifier = Modifier.fillMaxSize(),
                        scrollToTopRequests = liveScrollToTopRequests,
                        onPlayChannel = { channel ->
                            onPlayIptvChannel?.invoke(channel)
                        },
                    )
                }
